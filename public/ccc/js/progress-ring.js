(function ($) {
    $.fn.loadingRing = function () {
        ...
        $(this).each(function () {
            ...
            $target.append('<div class="progress-track"></div><div class="progress-left"></div><div class="progress-right"></div><div class="progress-cover"></div><div class="progress-text"><span class="progress-num">' + percent +'</span></div>');
